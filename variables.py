"""Python variables are simply containers for storing data values. Unlike other languages, such as Java.
Python has no command for declaring a variable, so we create one the moment we first assign a value to it.
"""
# Ex:- a= 12 , c = 20, d ="Vaibhav"
# here a,c & d are variable that stores the values.
